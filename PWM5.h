...
#define PWM5_PERIOD_VALUE    0xFAUL    /* Initial period value in ticks of the timer */
#define PWM5_PERIOD_VALUE_HIGH 0xFAUL  /* Initial period value in ticks of the timer in high speed mode */
