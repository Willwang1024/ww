...
static void HWEnDi(void)
{
  if (EnUser) {                        /* Enable device? */
    PWME_PWME7 = 1U;                   /* Run counter */
  } else {                             /* Disable device? */
    PWME_PWME7 = 0U;                   /* Stop counter */
    PWMCNT7 = 0U;                      /* Reset counter */
  }
}
...
{
  PWMDTY7 = (byte)(((0xFAUL * (dword)RatioStore) + 0x8000UL) >> 0x10U); /* Calculate new value according to the given ratio */
}
...
byte PWM7_SetValue(void)
{
  ...
  PWMPOL_PPOL7 = 1U;                   /* Set output signal level to high */
  PTP_PTP7 = 1U;
  return ERR_OK;                       /* OK */
}
...
byte PWM7_ClrValue(void)
{
  ...
  PWMPOL_PPOL7 = 0U;                   /* Set output signal level to low */
  PTP_PTP7 = 0U;
  return ERR_OK;                       /* OK */
}
...
void PWM7_Init(void)
{
  ...
  /* PWMDTY7: PWMDTY7=0x19 */
  setReg8(PWMDTY7, 0x19U);             /* Store initial value to the duty-compare register */ 
  /* PWMPER7: PWMPER7=0xFA */
  setReg8(PWMPER7, 0xFAU);             /* and to the period register */ 
  /* PWMCLK: PCLK7=1 */
