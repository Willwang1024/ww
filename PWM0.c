...
#pragma DATA_SEG PWM0_DATA             /* Select data segment "PWM0_DATA" */
...
{
  PWMDTY0 = (byte)(((0xFAUL * (dword)RatioStore) + 0x8000UL) >> 0x10U); /* Calculate new value according to the given ratio */
}
...
void PWM0_Init(void)
{
  ...
  /* PWMDTY0: PWMDTY0=0x19 */
  setReg8(PWMDTY0, 0x19U);             /* Store initial value to the duty-compare register */ 
  /* PWMPER0: PWMPER0=0xFA */
  setReg8(PWMPER0, 0xFAU);             /* and to the period register */ 
